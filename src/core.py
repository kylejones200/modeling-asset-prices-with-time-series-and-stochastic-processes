...
def simulate_wiener_process(n_steps: int=1000, T: float=1.0, seed: int | None=None) -> np.ndarray:
...
def simulate_gbm(S0: float=100, mu: float=0.05, sigma: float=0.2, T: float=1.0, n_steps: int=1000, seed: int | None=None) -> tuple[np.ndarray, np.ndarray]:
